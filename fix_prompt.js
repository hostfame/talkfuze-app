...
const target = `3. THE DIAGNOSTIC FLOW (HOW TO RECOMMEND HOSTING):
   ...
   - Rule: NEVER ask directly for their hosting budget. We gauge their pocket and traffic via daily ad spend. If ad spend is high, recommend the "Turbo" plan. If ad spend is low ($5-$10/day), start by recommending the "Web Pro" plan.`;
