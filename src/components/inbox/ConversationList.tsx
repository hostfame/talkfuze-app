            ...
            >
              ...
              <div className="relative">
                {contact?.avatar_url && !(contact?.platform_id?.endsWith('@g.us')) ? (
                  ...
                  <div className="w-10 h-10 rounded-full shrink-0 overflow-hidden bg-slate-100 flex items-center justify-center relative">
                    <img 
                      src={`https://api.dicebear.com/7.x/initials/svg?seed=${encodeURIComponent(contactName)}&fontFamily=Inter&fontWeight=600`} 
                      alt={contactName} 
                      className="w-full h-full object-cover z-10 bg-slate-100" 
                    />
                  </div>
              ...
              <div className="flex-1 min-w-0 mt-0.5 flex flex-col justify-center">
                ...
                <div className="flex justify-between items-center gap-2 mt-1">
                  ...
                  {lastMessage && lastMessage.sender_type === 'contact' && lastMessage.status !== 'read' && (
                    <div className="w-2 h-2 rounded-full bg-blue-500 shrink-0 shadow-[0_0_6px_rgba(59,130,246,0.5)]"></div>
                  )}
                </div>
              </div>
            </div>
