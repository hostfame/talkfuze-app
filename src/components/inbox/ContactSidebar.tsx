        ...
        <div className="p-5 border-b border-slate-100 flex items-start gap-3">
          <div className="w-10 h-10 rounded-full flex items-center justify-center font-semibold text-[14px] tracking-wide shrink-0 text-white bg-blue-600">
            {contact?.avatar_url && !(contact?.platform_id?.endsWith('@g.us')) ? (
              ...
              <img src={`https://api.dicebear.com/7.x/initials/svg?seed=${encodeURIComponent(contactName)}&fontFamily=Inter&fontWeight=600`} alt={contactName} className="w-full h-full object-cover rounded-full bg-slate-100" />
            )}
          </div>
      ...
      {activeTab === 'copilot' && (
        ...
        <div className="flex-1 flex flex-col min-h-0 bg-slate-50/50 dark:bg-slate-900/50 p-4 space-y-4 overflow-y-auto">
          <div className="p-4 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm flex flex-col items-center text-center">
            ...
            <h4 className="text-[14px] font-semibold text-slate-900 dark:text-white">Live Browsing Screen</h4>
