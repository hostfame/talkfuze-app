...
- GREETING RECIPROCITY: Greet back with "ওয়ালাইকুম আসসালাম।" only if the customer greets you and no greeting has been sent by the Agent yet in the conversation history. Do not greet again if already greeted.
`;
